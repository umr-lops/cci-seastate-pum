...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
cmd = ["ncdump", "-h", nc_file]

pattern = re.compile(r"[ \t,]swh[(,:]")

try:
    result = subprocess.run(cmd, check=True, capture_output=True, text=True)
    for line in result.stdout.splitlines():
        if pattern.search(line):
            # supprime tous les espaces (comme 'sed ... | tr -d [:space:]')
            print(re.sub(r"\s+", "", line))
except FileNotFoundError:
    print("❌ Le binaire `ncdump` n’est pas installé dans l’image Docker.")
except subprocess.CalledProcessError as e:
    print(f"❌ Échec de la commande `ncdump` :\n{e.stderr}")
```
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_rms[(:,]")

try:
    result = subprocess.run(["ncdump", "-h", nc_file], capture_output=True, text=True, check=True)
    for line in result.stdout.splitlines():
        if pattern.search(line):
            print(re.sub(r"\s+", "", line))  # Équivalent à sed 's/[[:space:]]//'
except FileNotFoundError:
    print("❌ Le binaire ncdump est introuvable.")
except subprocess.CalledProcessError as e:
    print(f"❌ Erreur lors de l'exécution de ncdump :\n{e.stderr}")
```
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_numval[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_adjusted[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_denoised[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_uncertainty[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_quality_level[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_rejection_flags[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_emd_noise[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_emd_imf1[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]swh_emd_uncertainty[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]sigma0_ku[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]sigma0_ku_num_valid[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]sigma0_ku_quality_level[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]sigma0_ku_rejection_flags[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]distance_to_coast[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]bathymetry[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]sea_ice_fraction[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_total_column_cloud_liquid_water[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_2m_air_temperature[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_sea_surface_temperature[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_eastward_wind[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_northward_wind[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_surface_pressure[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_peak_wave_period[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_swell_mean_period[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_swell_swh[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_swell_direction[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_mean_wave_period[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_mean_wave_direction[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_windwave_swh[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_windwave_direction[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]era5_windwave_period[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]ww3_mean_wave_period[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]ww3_mean_wave_period_t0m1[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]ww3_peak_wave_period[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]ww3_mean_wave_direction[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]ww3_wave_skewness[(:,]")
...
nc_file = "../samples/ESACCI-SEASTATE-L2P-SWH-ERS-1-19950410T002419-fv01.nc"
pattern = re.compile(r"[ ,\t]ww3_wavenumber_peakdness[(:,]")
