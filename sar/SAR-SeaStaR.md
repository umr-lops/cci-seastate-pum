...
This optimization allows processing data for ambiguous enviroment conditions dominate in coastal ares (artifacts by ships, buoys, watermarks, windparks, etc.) and by low winds under 2 m/s.
